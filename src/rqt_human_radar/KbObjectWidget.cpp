  ...
  tf_broadcaster_(node)
{
  ...
  connect(
    this, &KbObjectWidget::customContextMenuRequested, this,
...
void KbObjectWidget::pxPlace(const QPoint & pos)
{
  ...
  auto x = (pos.x() - xOffset) / static_cast<double>(pixelPerMeter);
  auto y = (yOffset - pos.y()) / static_cast<double>(pixelPerMeter);
